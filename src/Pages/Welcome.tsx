...
import { Consumer } from '../Interfaces/Consumer.tsx'; // Importa la interfaz Consumer
...
function Welcome() {
  ...
  return (
      <div className="App">
        {/* Aquí agregamos el formulario de registro */}
        ...
        <h1>Supabase Database on React Page</h1>
        ...
        {loading ? (
          ...
          <>
            {consumer.length === 0 ? (
              <p>There are no consumers in the list.</p>
            ) : (
              <ul>
